...
export default function SecondForm() {
    ...
    const passProductToPricesSetting = () => {
        navigate(`/thirdForm`, { state: { product } })
    }
    //
    ...
    return (
        <div style={{ textAlign: "center" }}>
            ...
            <h4>Weight:</h4>
            <br />
            <input type='number' name="weight" value={productDetail.weight} onChange={handleInputWeight}></input>
            <br />
            <br />
            <h4>CPU:</h4>
            <br />
                ...
                <table className='product-images-table'>
                    {imgObjList.map((i, index) => (
                        <tr>
                            ...
                            <td>
                                <img className='product-image-per-variant' src={i.url} alt='' />
                            </td>
                            <td>
